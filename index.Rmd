...
author: "Dania María Zuñiga Herrera"
date: "2020-10-20"
output:
  html_document:
    theme: readable    
...
```{r}
# Se extraen las observaciones correspondientes a los países de asia con EV de al menos 80 años
Asia = world[world$name_long == "Cyprus" |
                       world$name_long == "Israel" |
                       world$name_long == "Japan" |
                       world$name_long == "Republic of Korea", ]

#Gráfica de países asiáticos con una esperanza de vida de al menos 80 años
ggplot(Asia, aes(x=reorder(name_long, -lifeExp), y=lifeExp)) +
  ggtitle("Esperanza de vida en paises asiáticos") +
  xlab("País") + 
...
Oceania_países = world.ordenadoxpais[world.ordenadoxpais$continent == "Oceania", ]

# Mapa de corpletas de esperanza de vida en Oceanía
plot(
 Oceania_países["lifeExp"], 
  main="Esperanza de vida en Oceanía"
)
...
```{r}
# Países centroamericanos con esperanza de vida >= 74 años

popcentroamerica <- world[world$subregion == "Central America",] %>%
  filter(lifeExp >=74)

#Mapa de corpletas de población centromericana con esperanza de vida >= 74 años

plot(
  popcentroamerica["lifeExp"], 
  main="Población con experanza de vida mayor e igual a 74 años,centroamerica"
)
...
popsuramerica <- world[world$subregion == "South America",] %>%
  filter(pop >= 40000000, area_km2 >= 2000000)

#Mapa de corpletas Población de al menos 40 millones de personas

plot(
  popsuramerica["pop"], 
  main="Población de al menos 40 millones de personas,América del Sur"
)

# Mapa de corpletas países de América del sur con al menos un área de 2.5 millones km2

plot(
  popsuramerica["area_km2"], 
  main="Países América del Sur(2.5 millones km2)"
)
